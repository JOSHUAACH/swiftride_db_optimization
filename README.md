# New project with data team AND they are contributers to the project
...
Markdown tables now support basic smart selection. Use Expand Selection (⌃⇧⌘→) to grow the selection from a cell to its row and then to the full table, and Shrink Selection (⌃⇧⌘←) to step back down.
